...
class InTest extends TestCase
{
    ...
    public function it_can_filter_string_fields()
    {
        ...
        $this->assertEquals(['LAF_0001', 'LAF_0005'], $orders->pluck('reference')->toArray());
    }
    ...
    public function it_can_filter_numeric_fields()
    {
        ...
        $this->assertEquals(['LAF_0003', 'LAF_0004'], $orders->pluck('reference')->toArray());
    }
    ...
    {
        $shipDate = '["2020-10-3 10:30:00", "2020-09-30 5:25:04"]';
